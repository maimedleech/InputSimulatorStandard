...
namespace WindowsInputPlus.Native
{
    /// <summary>
    ...
    {
        /// <summary>
        /// The <see cref="GetAsyncKeyState"/> function determines whether a key is up or down at the time the function is called, and whether the key was pressed after a previous call to GetAsyncKeyState. (See: http://msdn.microsoft.com/en-us/library/ms646293(VS.85).aspx)
        /// </summary>
        ...
        /// <summary>
        /// The <see cref="SendInput"/> function synthesizes keystrokes, mouse motions, and button clicks.
        /// </summary>
